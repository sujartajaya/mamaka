...
CREATE TABLE `client_devices` (
  ...
  `brand_client` varchar(255) DEFAULT NULL,
  `model_client` varchar(255) DEFAULT NULL,
...
CREATE TABLE `countries` (
  ...
  `time_zone_in_capital` varchar(255) NOT NULL,
...
CREATE TABLE `users` (
  ...
  `email` varchar(255) NOT NULL,
  `username` varchar(255) NOT NULL,
  `type` enum('admin','operator','user') NOT NULL DEFAULT 'user',
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (19,'2025_03_01_030008_create_countries_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (20,'2025_03_01_053102_create_guests_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (21,'2025_07_18_140657_create_telegrams_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (25,'2025_08_07_151836_add_client_columns_to_guests_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (26,'2025_09_08_121305_create_client_devices_table',3);
