...
<body class="bg-blue-500">
	<nav class="relative px-4 py-4 flex justify-between  bg-white">
		...
		<button type="submit"
			class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-red-200 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200"
			onclick="event.preventDefault();document.getElementById('logout-form').submit();">Logout</button>
		@else
		<a class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-200 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200"
		...
		<nav
			...
			<div class="mt-auto">
				<div class="pt-6">
					@if(Auth::check())
					<form id="logout-form" action="{{ route('logout') }}" method="POST">@csrf</form>
					<a class="block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold leading-none bg-red-200 hover:bg-gray-100 rounded-xl"
						onclick="event.preventDefault();document.getElementById('logout-form').submit();">Logout</a>
					@else
					<a class="block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold leading-none bg-gray-200 hover:bg-gray-100 rounded-xl"
						href="{{ route('login') }}">Sign in</a>
					@endif
