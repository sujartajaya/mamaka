...
<div class="container mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <div id="flashMessage" class="fixed top-4 left-1/2 transform -translate-x-1/2 w-auto px-4 py-3 rounded-lg shadow-lg text-white text-center bg-red-500 z-50">
    <span id="flashText" >
    ...
    <div class="overflow-x-auto flex w-full max-w-wd bg-white rounded-lg  justify-start items-center mt-2 mb-4 space-x-2">
                  <input
                    ...
                    />
                  <button id="btnAddmac" class="max-w-sm mn-w-[150px] p-2 text-gray-900 bg-gradient-to-r from-blue-200 via-blue-400 to-blue-500 hover:bg-gradient-to-br focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Add Mac</button> 
    </div>    
      ...
      <button id="nextBtn" class="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300">Next</button>
        ...
        <div id="macModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center hidden">
                <div class="bg-white w-full max-w-4xl rounded-lg shadow-lg">
                    ...
                    <div class="relative p-6 flex-auto">
                                        ...
                                        <div class="flex flex-wrap -mx-3 mb-4">
                                                    <div class="w-full md:w-1/2 px-3">
                                                        ...
                                                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="mac" type="text" placeholder="00:00:00:00:00:00" name="mac">
                                                    </div>
                                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="type">
                                                            Type
                                                        </label>
                                                        <select class="block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="type" name="type">
                                        ...
                                        <div class="flex flex-wrap -mx-3 mb-4">
                                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                                        ...
                                                        <input class="block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="comment" type="text" placeholder="Description" name="comment">
                                                    </div>
                                                    <div class="w-full md:w-1/2 px-3 hidden" id="frmdisable">
                                                        ...
                                                        <select class="block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="disabled" name="disabled">
                    ...
                    <input id="submitBtn"  class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400" value=""/>
                    </form>
                    <button
                        id="closeBtn"
        ...
        try {
            ...
            searchInput.addEventListener('input', (e) => {
                ...
                filteredData = data.filter(item =>
                    item['mac-address'].toLowerCase().includes(searchTerm) || item['type'].toLowerCase().includes(searchTerm) || item['comment'].toLowerCase().includes(searchTerm)
                );
                currentPage = 1;
                renderTable(currentPage);
                updatePaginationButtons();
